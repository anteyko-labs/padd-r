...
async function main() {
  ...
  const padToken = PADToken.attach("0x3F1e88d23a4De39503960f1f0bFa13d36962b76b");

  const MultiStakeManager = await ethers.getContractFactory("MultiStakeManager");
  const multiStakeManager = MultiStakeManager.attach("0x2F093ADFE29F21B2e9Dfd3F116835650a65cCabA");

  const PADNFTFactory = await ethers.getContractFactory("PADNFTFactory");
  const padNFTFactory = PADNFTFactory.attach("0xF3Dc58242fd58f833Df333f8db1B96BFB5b156f4");
